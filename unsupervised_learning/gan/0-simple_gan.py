...
class Simple_GAN(keras.Model) :
    ...
    def __init__( self, generator , discriminator , latent_generator, real_examples, batch_size=200, disc_iter=2, learning_rate=.005):
        ...
        self.discriminator.compile(optimizer=discriminator.optimizer , loss=
                discriminator.loss )
    ...
    def train_step(self,useless_argument):
        for _ in range(self.disc_iter) :
            ...
            #self.discriminator.apply_gradients(zip(a, self.discriminator.weights))
        ...
        b=h.gradient(gen_loss,self.discriminator.weights)
        #self.discriminator.optimizer.apply_gradients(zip(b, self.discriminator.weights))
